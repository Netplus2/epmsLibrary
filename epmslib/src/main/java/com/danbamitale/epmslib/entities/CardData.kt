...
data class CardData(
    ...
    val pan = getPan(track2Data)
    val serviceCode = getServiceCode(track2Data)
    val expiryDate = getExpiryDate(track2Data)
    val acquiringInstitutionIdCode = getAcquiringInstitutionIdCode(track2Data)
